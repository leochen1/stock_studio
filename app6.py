...
def crawelrCompanyData():
    try:
        ...
        stock_codes_1 = df1['有價證券代號'].apply(lambda x: x+'.TW').tolist()  # TWSE 上市
        stock_codes_2 = df2['有價證券代號'].apply(lambda x: x+'.TWO').tolist()  # TWSE 上櫃
...
def analyze_stock(stock_code):
    ...
    if last_row['+DI_increase'] and last_row['-DI_decrease'] and last_row['ADX_increase'] and last_row['ADX_less_than_20'] and last_row['Volume_increase'] and last_row['Volume_1000'] > 1000 and last_row['Close_less_than_100'] < 100:
        return True
    else:
        return False
